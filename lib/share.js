...
successMsg.innerHTML = "YAY YOU FINISHED!";
...
fbBtn.addEventListener('click', function(event) {
    ...
    var w = 580, h = 300,
        ...
        window.open("http://yahoo.com", 'newwindow', 'width=300,height=300');
...
twBtn.addEventListener('click', function(event) {
	var loc = encodeURIComponent('http://bit.ly/ksstweet'),
	    ...
	    window.open('http://bit.ly/ksstweet?text=' + title + '&url=' + loc, '', 'height=' + "300" + ', width=' + "300");
